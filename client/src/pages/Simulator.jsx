...
function StartScreen({ initAmount, setInitAmount, onStart }) {
  const invalid = !initAmount || Number(initAmount) <= 0;
    ...
    <div className="min-h-[calc(100vh-56px)] bg-stone-50 flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        ...
        <p className="text-sm text-stone-500 text-center mb-8 leading-relaxed">
          Make real-world financial decisions across 6 months of market ups and
          downs. See how your choices play out.
        </p>

        <div className="grid grid-cols-3 gap-3 mb-8">
          {[
            { label: "Scenarios", value: "7" },
            { label: "Duration", value: "6 mo" },
            { label: "Choices", value: "4/step" },
          ].map(({ label, value }) => (
            <div
              key={label}
...
function ResultsScreen({ choices, initAmount, onRestart }) {
  return (
...
function Simulator() {
  ...
  return (
    <div className="min-h-[calc(100vh-56px)] bg-stone-50 px-4 py-8">
